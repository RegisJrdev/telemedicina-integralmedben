...
const submit = () => {
    form.post(route('leis.store'), {
        ...
        onError: (errors) => {
            const message = errors.title || errors.text || 'Erro ao salvar lei';
...
<template>
    ...
    <CentralAdminLayout>
        ...
        <div class="flex flex-wrap items-center justify-between gap-2 mb-6">
            <div class="space-y-1">
                ...
                <p class="text-sm text-gray-500">
                    Cadastre uma nova norma, lei ou documento regulatório
                </p>
            </div>
        ...
        <div class="space-y-6 mx-auto  ">
            ...
            <!-- Layout Principal: 2 colunas (6/6) -->
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 items-start">
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-blue-50 rounded-xl border border-blue-200 p-4">
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                <h3 class="font-semibold text-blue-900 mb-1">Dicas</h3>
                                <ul class="text-sm text-blue-800 space-y-2 list-disc list-inside">
                                    <li>Use títulos claros e objetivos</li>
                                    <li>Selecione o tipo correto para facilitar buscas</li>
                                    <li>Salve como <strong>rascunho</strong> enquanto estiver editando</li>
                                    <li>O conteúdo pode ser editado depois</li>
                                    <li>Textos longos são aceitos (até 65.000 caracteres)</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="lg:sticky lg:top-6">
                    ...
                    <div class="mt-4 bg-white rounded-xl border border-gray-200 p-4">
                        <h4 class="font-medium text-gray-700 mb-2 text-sm">Resumo</h4>
        ...
        <div v-if="showFullPreview" class="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div class="relative bg-white rounded-xl shadow-xl w-full max-w-4xl max-h-[90vh] flex flex-col">
                ...
                <!-- Conteúdo scrollável VERTICAL apenas -->
