...
class UpdateFormRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'credencia_cluble_id.exists'  => 'A credencia cluble selecionada não existe.',
            'credencia_cluble_id.integer' => 'A credencia cluble  selecionada é inválida.',
    ...
    public function attributes(): array
    {
        $attributes = [
            ...
            'credencia_cluble_id' => 'credencia_cluble',
        ];
